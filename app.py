...
from mysql.connector import Error  # Add this import statement
...
from utils import camelcase, get_area_code, parse_date, refresh_bookings_df, test_db_connection
...
physical_rooms = get_physical_rooms()
